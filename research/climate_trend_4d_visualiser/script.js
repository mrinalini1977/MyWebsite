function draw(data)
{
		...
		var body = d3.select("#chartContainer");
				body.append("br");
		...
		chart.setBounds(margin.left, margin.top + buttonHeight * 1.2, svgWidth - margin.left - margin.right - buttonWidth,svgHeight - margin.top - margin.bottom - buttonHeight);
		...
		chart.addLegend(svgWidth-(margin.left * 10), margin.top, 450, buttonHeight);
    	chart.draw();
